...
<html>
    ...
    <body>
        ...
        El alumno con nombre <strong> ${elAlumno.nombre}</strong>, apellido <strong>${elAlumno.apellido}</strong>, edad <strong>${elAlumno.edad}</strong>, email <strong>${elAlumno.email}</strong> y C. Postal <strong>${elAlumno.codigoPostal}</strong> se ha registrado con éxito.<br/> 
